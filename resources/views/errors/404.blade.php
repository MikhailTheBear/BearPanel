...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - {{ __('Not Found') }}</title>
            ...
            <div class="bg-white shadow rounded-lg p-8 sm:p-12">
                <div class="text-center">
                    ...
                    <div class="text-sm text-gray-600 max-w-md mx-auto mb-8">
                        <p>
                            {{ __('The page you are looking for does not exist or was moved.') }}
                        </p>
                    </div>
