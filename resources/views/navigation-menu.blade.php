        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <div class="h-9 w-9 rounded-lg bg-gray-900 text-white grid place-items-center font-bold">
                        BP
                    </div>
                    <div class="leading-tight">
                        <div class="text-sm font-semibold text-gray-900">BearPanel</div>
                    ...
                    @if (Auth::user()?->is_admin)
                        ...
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="{{ route('admin.servers.index') }}">
                                    Servers
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()?->is_admin)
                ...
                <x-responsive-nav-link href="{{ route('admin.nodes.index') }}" :active="request()->routeIs('admin.nodes.*')">
                    Nodes
                </x-responsive-nav-link>
